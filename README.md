...
Then, to install you will simply copy the contents of release into the directory where you're keeping your scripts and make the script executeable by running
